...
export default function VacancyFeedBackForm({ sourcePage }) {
    ...
    <RootStyle>
      ...
      <Container>
        <Grid container alignItems="center">
          ...
          >
            <Typography variant="h2">Станьте частью нашей команды</Typography>

            <Typography sx={{ mt: 3, mb: 5, opacity: 0.72 }}>
              Откликнетесь на вакансию через форму обратной связи — оставьте свои контактные данные, чтобы мы смогли связаться с вами.
            </Typography>
          </Grid>
            ...
            <FormProvider methods={methods} onSubmit={handleSubmit(onSubmit, onError)}>
              <Stack spacing={3.5}>
                ...
                <Stack spacing={1}>
                  ...
                  >
                    Нажимая на кнопку 'Откликнуться', вы соглашаетесь с {' '}
                    <a
                      href="/privacy-policy"
                      style={{
